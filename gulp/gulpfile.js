...
gulp.task('start', function() {
    gulp.src('dist/index.html')
        .pipe(notify('Gulp has been started...'));
});
...
gulp.task('watch', function() {
    ...
    gulp.watch(['src/prod.marker'], ['html-prod', 'style-prod', ,'style-js', 'css-prod']);
...
gulp.task('default', ['start', 'connect', 'watch', 'images', 'sprites']);